@extends('frontoffice.layouts.master', ['title' => 'Conditions générales d\'utilisation'])

@section('content')
	<div id="texte_a_afficher" class="main-content">
		<div class="content">
			<div class="container">
				...
				<p>L'application <span id="span_id_nom_site">APRIL</span> a pour objet :</p>
				<p style="padding-left: 30px;"><span id="span_id_description_personnalisee_du_site"><span class="variable_vide">la prise de rendez-vous en ligne à l'Hôpital Central de Yaoundé</span></span></p>
				<p><strong><br>ARTICLE 3. CONTACT</strong></p>
				<p>Pour toute question ou demande d'information concernant le site, ou tout signalement de contenu ou d'activités illicites, l'utilisateur peut contacter l'éditeur à l'adresse e-mail suivante: <span id="span_id_adresse_e_mail_de_contact_pour_le_dp">info@hopitalcentral.cm</span> ou adresser un courrier recommandé avec accusé de réception à : <span id="span_id_nom_editeur">l'Hôpital Central de Yaoundé</span> - <span id="span_id_adresse_siege_social_editeur">Rue 2.008 derrière CENAME,  Yaoundé, Cameroun</span></p>
				...
				<p>La connexion et la navigation sur le site <span id="span_id_nom_site">APRIL</span> valent acceptation sans réserve des présentes Conditions Générales d'Utilisation, quelques soient les moyens techniques d'accès et les terminaux utilisés.</p>
				...
				<p>L'accès à certains services est conditionné par l'inscription de l'utilisateur.</p>
				<p>L'inscription et l'accès aux services du site sont réservés exclusivement aux personnes physiques  capables, ayant rempli et validé le formulaire d'inscription disponible en ligne sur le site <span id="span_id_nom_site">APRIL</span>, ainsi que les présentes Conditions Générales d'Utilisation.</p>
				...
				<p>Toute communication réalisée par <span id="span_id_nom_site">APRIL</span> et ses partenaires est en conséquence réputée avoir été réceptionnée et lue par l'utilisateur. Ce dernier s'engage donc à consulter régulièrement les messages reçus sur cette adresse e-mail et à répondre dans un délai raisonnable si cela est nécessaire.</p>
				...
				<p><span id="span_id_nom_site">APRIL</span> se réserve en tout état de cause la possibilité de refuser une demande d'inscription aux services en cas de non-respect par l'utilisateur des dispositions des présentes Conditions Générales d'Utilisation.<br><br></p>
				...
				<ul>
					<li>Des contenus ou activités illicites utilisant son site et ce, sans qu'il en ait pris dûment connaissance au sens de la Loi n° <span class="flou">0883-383 bb 01 abfb 0883 dcbf fc acbbfcbaa bcba f'aacbcafa bbaaffeba af fc Ecf b°0883-381 bb 3 ccbf 0883 fafcffea c fc dfcfaaffcb baa dafacbbaa dapafebaa</span> à l'égard de traitement de données à caractère personnel.</li>
				</ul>
				...
				<p>Le site peut contenir des liens hypertextes pointant vers d'autres sites internet sur lesquels <span id="span_id_nom_site">APRIL</span> n'exerce pas de contrôle. Malgré les vérifications préalables et régulières réalisés par l'éditeur, celui-ci décline tout responsabilité quant aux contenus qu'il est possible de trouver sur ces sites.</p>
				...
				<p>Enfin, <span id="span_id_nom_site">APRIL</span> se réserve le droit de faire supprimer à tout moment un lien hypertexte pointant vers son site, si le site l'estime non conforme à sa politique éditoriale. </p>
				...
				<p style="text-align: center;"><em>Nous vous souhaitons une excellente navigation !</em></p>
			</div>
